...
function editMenuItem_tools(res, data, sellerID){
    ...
    let tags;
			let q1 = `select tagID from Tags where name in ('${body.Cuisine}', '${body["Dietary Restriction"]}',  '${body["Service Type"]}',  '${body["Special Tags"]}',  '${body["Food Category"]}',  '${body["Meal Type"]}') order by tag_id;`;
