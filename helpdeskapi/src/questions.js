...
const router = (req, res) => {
    ...
    if (url.includes('/questions/create')) {
                        ...
                        if (req.method === 'POST') {
                            ...
                            req.on('end', () => {
                                try {
                                    ...
                                    db.run(q, [question, answer], (err, results) => {
                                        //handle error
                                        if (err) {
                            ...
                            req.on('end', () => {
                                try {
                                    ...
                                    if (Task == 'update') {
                                        ...
                                        db.run(q, [question, answer, question_id], (err, results) => {
                                            if (err) {
                                                res.writeHead(500, { 'Content-Type': 'text/plain' });
                                                res.end('Server error');
                                            } else {
                                        ...
                                        db.run(q, [question_id], (err, results) => {
       ...
       else if (url.includes('/questions/token')) {
                                ...
                                try {
                                    ...
                                    db.all(q, (err, results) => {
                                        if (err) {
                                            ...
                                            fs.readFile('questions.html', (err, questionData) => {
                                                if (err) {
                                                    res.writeHead(500, { 'Content-Type': 'text/plain' });
                                                    res.end('Server error');
                                                } else {
